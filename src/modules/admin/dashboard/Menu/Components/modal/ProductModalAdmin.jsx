...
const ProductModalAdmin = ({isModalVisible, setIsModalVisible, form, handleSubmit, currentProduct }) => {
  ...
  return (
    <Modal
      title={currentProduct ? 'Editar Entrada' : 'Nueva Entrada'}
      open={isModalVisible}
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '8px' }}>
          <Button type="primary" htmlType="submit">
            {currentProduct ? 'Guardar Cambios' : 'Crear Entrada'}
          </Button>
        </div>
      </Form>
    </Modal>
