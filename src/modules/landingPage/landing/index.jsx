...
const LandingPage = () => {
  ...
  const showPrivacyModal = () => setPrivacyVisible(true);
  const handlePrivacyAccept = () => setPrivacyVisible(false);

  const showTermsModal = () => setTermsVisible(true);
  const handleTermsAccept = () => setTermsVisible(false);
  ...
  return (
    <Layout className="landing-layout">
      ...
      <Modal
        ...
        onCancel={handlePrivacyAccept}
        footer={[
          <Button key="accept-privacy" type="primary" onClick={handlePrivacyAccept}>
            Aceptar
          </Button>,
        ]}
        width={700}
      >
        <div style={{ maxHeight: "60vh", overflowY: "auto", paddingRight: "1rem" }}>
          <Text>
            ...
            <b>Recopilación de información personal:</b><br />
            ...
            <b>Seguridad de la información:</b><br />
            ...
            <b>Cookies y tecnologías de seguimiento:</b><br />
            ...
            Al utilizar nuestra carta digital, usted acepta y consiente nuestras políticas de privacidad. Para cualquier pregunta o inquietud con respecto a nuestras políticas de privacidad, no dude en ponerse en contacto con nosotros.
          </Text>
        </div>
      </Modal>
      ...
      <Modal
        ...
        footer={[
          <Button key="accept-terms" type="primary" onClick={handleTermsAccept}>
            Aceptar
          </Button>,
        ]}
        width={700}
      >
        <div style={{ maxHeight: "60vh", overflowY: "auto", paddingRight: "1rem" }}>
          <Text>
            <b>Pollería El Ricoton</b><br /><br />
            Al acceder y utilizar este catálogo online, el usuario acepta los términos y condiciones establecidos a continuación. Si no está de acuerdo con estos términos, le solicitamos abstenerse de utilizar este servicio.<br /><br />

            La carta digital <a href="https://polleria-el-ricoton.glide.page" target="_blank" rel="noopener noreferrer">https://polleria-el-ricoton.glide.page</a> tiene como objetivo proporcionar información detallada sobre nuestros productos y servicios. Sin embargo, no garantizamos la exactitud, integridad o actualidad de la información contenida en el catálogo y no nos hacemos responsables por cualquier error u omisión en los detalles de los productos u otra información.<br /><br />

            Los precios y la disponibilidad de los productos en el catálogo están sujetos a cambios sin previo aviso. Nos reservamos el derecho de modificar los precios, descripciones y especificaciones de los productos en cualquier momento sin ninguna obligación de notificación.<br /><br />

            El contenido de la carta digital, incluyendo imágenes, textos y logotipos, está protegido por derechos de autor y otros derechos de propiedad intelectual. Queda estrictamente prohibida cualquier reproducción, distribución, modificación o uso no autorizado del contenido sin nuestro consentimiento expreso por escrito.<br /><br />
            ...
            No nos hacemos responsables por cualquier daño o perjuicio directo, indirecto, consecuente o incidental derivado del uso o la imposibilidad de utilizar el catálogo online, incluyendo, entre otros, pérdida de datos, interrupción del negocio, o cualquier otra pérdida financiera.<br /><br />

            Nos esforzamos por mantener el catálogo online libre de virus informáticos y otros elementos perjudiciales. Es responsabilidad del usuario contar con las medidas adecuadas y actualizadas de seguridad informática para proteger su dispositivo y su información.<br /><br />

            Nos reservamos el derecho de suspender, modificar o discontinuar el catálogo online en cualquier momento y sin previo aviso.<br /><br />

            Estos términos y condiciones se rigen por las leyes vigentes de (país) y cualquier disputa que surja en relación con estos términos estará sujeta a la jurisdicción exclusiva de los tribunales de (ciudad, país).<br /><br />
